...
We are now going to look at a sample Nextflow script that extracts a folder with data files. First step involves navigating to the relevant script, `02_hello_nextflow.nf` in the current directory. The instructions to set up the code material can be found under [setup](https://omiridoue.github.io/sgsss-workflow/index.html). 

:::::::::::::::::::::::::::::::::::::::  challenge

## Task 2.1

The nextflow scripts for each lesson episode are available in the `scripts` directory created during the course setup. You should enter this folder by changing directory. Check that your terminal displays the following file path:
