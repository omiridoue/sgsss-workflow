...
- What are ways I might name and organise my files?
...
- **Accessible** - in order to reuse software, the software and its metadata must be retrievable, free and legally usable.
- **Interoperable** - appropriate scaffolding in place for different languages to be used.
- **Reusable** - software that can be understood, modified, built upon, or incorporated into other software.
...
- Use standards (such as [CodeMeta][codemeta]) to describe interoperable metadata for your software 
- Use a unique and persistent identifier (DOI) for your software (e.g. by depositing your code on Zenodo, OSF, GitHub)

:::::::::::::::::::::::::::::::::::::::: warning

  Note that depositing your data/code on GitHub and similar software repositories may not be enough as they may change their open access model or disappear completely in the future, so archiving your code means it stands a better chance at being preserved.
...
4. Optional: Generate file names dynamically
...
Naming folders according to a logical number can lead to a mess if the ordering changes in the future. Try to future proof your work, ex. work with a generalisable template to prevent intended order from changing.

<div style='position: relative; padding-bottom: 56.25%; padding-top: 35px; height: 0; overflow: hidden;'>
  <p style="padding: 0; margin: 0;">
    <iframe sandbox='allow-scripts allow-same-origin allow-presentation' allowfullscreen='true' allowtransparency='true' frameborder='0' height='315' src='https://www.mentimeter.com/app/presentation/alfn4xpqitna69dtr66ktgv1278zfrys/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'></iframe>
  </p>
</div>

### Generated dynamically

Output in multiple forms can be generated as part of running a computational pipeline. Result files can contain a key identifier or label, depending on your unit of analysis. Workflow managers offer important scaffolding to support how you track the **flows** of inputs and outputs across multiple stages of a pipeline. The identifier may well be a pseudonym if your project works with confidential data. We can come back to this to see how we can assign handy *process labels* in our workflow with base functions like `paste0()` in *R statistical software* to concatenate literal words or values with ones that depend on the input flowing into a process. 

:::::::::::::::::: checklist

A little work and time investment early on in project design saves a lot of time later when any circumstances arise that demand change. Does this apply to my PhD, the answer is ‘yes’. The project design will allow you to manage your work well for yourself (see the section: Getting Started Checklist).
