...
Write a Nextflow script that creates `value` channel. 
...
1. Use the `fromFilePairs` method to create a channel containing four tuples. Each tuple will contain the pairs of data reads for the four schools with synthetic data in the `data/` directory. 
