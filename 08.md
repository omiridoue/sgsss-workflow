...
For example here we use the the `view` operator and apply a closure to it, to separate the first two columns of the csv file as separate parameters and group all remaining columns into a single list of parameters.
