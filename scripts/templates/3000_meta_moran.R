...
School_exclPI_raw <- readRDS(sim_files[[2]])
School_exclPS_raw <- readRDS(sim_files[[3]])
...
output <- moran_decomposition(School_raw, School_exclPI_raw, School_exclPS_raw, School_exclBoth_raw, nodes, school_period)
